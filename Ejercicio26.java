...
public class Ejercicio26{
	public static void main(String[] args){
        ...
        System.out.println("Con este programa haremos un turron con un bocado ");
        System.out.println("Diga la anchura, como minimo 2 ");
        int anchura = sc.nextInt();
        System.out.println("Diga la altura, como minimo 2 ");
        int altura = sc.nextInt();
        //se puede morder por los cuatros lados, para eso tenemos que hacer una variable
        //aleatoria para que escoja un lado y luego otra para la posicion de ese lado
